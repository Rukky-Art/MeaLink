...
const AvailableListings = () => {
  ...
  return (
    <section className="py-24 bg-brand-mint/20 font-be-vietnam">
...
const ListingCard = ({ listing, handleClaimClick }) => {
  ...
  const { img, label } = getCategoryStyles(listing.category);
    ...
    <div className="bg-white rounded-3xl border border-gray-100 overflow-hidden group hover:shadow-2xl transition-all duration-500 flex flex-col h-full">
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute top-4 left-4 flex gap-2">
          <span className="bg-brand-green text-white text-[10px] font-bold px-2 py-1 rounded-md uppercase tracking-wider shadow-sm">
            Available
          </span>
