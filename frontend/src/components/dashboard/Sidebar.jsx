...
const Sidebar = () => {
  ...
  const roleLinks = {
    donor: [
      ...
      { label: 'My Listings',    icon: List,            path: '/dashboard/my-listings',    end: false },
      { label: 'Create Listing', icon: Plus,            path: '/dashboard/create-listing', end: false },
      { label: 'Notifications',  icon: Bell,            path: '/dashboard/notifications',  end: false },
    ],
    partner: [
      { label: 'Overview',        icon: LayoutDashboard, path: '/dashboard',              end: true  },
      // end: true so /dashboard/browse/:id doesn't keep "Available Food" highlighted
      { label: 'Available Food',  icon: Package,         path: '/dashboard/browse',       end: true  },
      { label: 'My Claims',       icon: List,            path: '/dashboard/my-claims',    end: false },
    ],
    admin: [
      { label: 'Overview',     icon: LayoutDashboard, path: '/dashboard',              end: true  },
      { label: 'All Listings', icon: List,            path: '/dashboard/all-listings', end: false },
      { label: 'Partners',     icon: Users,           path: '/dashboard/partners',     end: false },
    ],
  };
